...
namespace JyGame.BattleNet
{
    ...
    public class BattleNetManager
    {
        ...
        static public void Init(string ip, int port, Dispatcher dispatcher)
        {
            _instance = new BattleNetManager(ip, port, dispatcher);
        }
        ...
        public BattleNetManager(string ip = "www.jy-x.com", int port = 4502, Dispatcher dispatcher = null)
        {
        ...
        const int RECV_BUFFER_SIZE = 1024 * 1024 * 2;
        ...
        void recvArgs_Completed(object sender, SocketAsyncEventArgs e)
        {
            if (e.LastOperation == SocketAsyncOperation.Receive)
            {
                ...
                //处理接收的数据
                this.ProcessMessage(RecevieStr);
